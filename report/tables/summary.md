...
| O: 200.2 req/s actually offered | 1 backend(s) | **118.64** achieved | 715.03 | 7422.47 | 2038 failed (of which 797 dropped) | 1-1 |
| O: 205.5 req/s actually offered | 2 backend(s) | **205.48** achieved | 283.48 | 4488.56 | 0 failed (of which 0 dropped) | 2-2 |
| O: 220.7 req/s actually offered | 3 backend(s) | **220.68** achieved | 64.08 | 267.6 | 0 failed (of which 0 dropped) | 3-3 |
...
| ALGO: 50 users, sys3 CPU-loaded | adaptive | **247.0** | 89.06 | 1135.83 | 0 | share sys3 = 25.0 % |
| ALGO: 50 users, sys3 CPU-loaded | round_robin | **201.81** | 38.8 | 492.81 | 0 | share sys3 = 33.1 % |
| ALGO: 50 users, sys3 CPU-loaded | least_connections | **257.33** | 80.31 | 1252.91 | 0 | share sys3 = 27.5 % |
